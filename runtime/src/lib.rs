...
pub const VERSION: RuntimeVersion = RuntimeVersion {
    spec_name: create_runtime_str!("node-vnrs"),
    impl_name: create_runtime_str!("node-vnrs"),
    authoring_version: 1,
...
parameter_types! {
    pub const ApprovalDeposit: u64 = 256;
    pub const AssetDeposit: u64 = 1;
    pub const ExistentialDeposit: u128 = 500;
    pub const MaxLocks: u32 = 50;
    pub const MetadataDepositBase: u64 = 256;
    pub const MetadataDepositPerByte: u64 = 256;
...
pub struct NextLockId;
impl pallet_vnrs::NextLockId for NextLockId {
    fn next_lock_id() -> frame_support::traits::LockIdentifier {
        *b"12345678"
    }
}

impl pallet_vnrs::Config for Runtime {
    type Event = Event;
...
construct_runtime!(
        ...
        UncheckedExtrinsic = UncheckedExtrinsic
    {
        ...
        VnrsModule: pallet_vnrs::{Pallet, Call, Storage, Event<T>},
    }
);
...
impl_runtime_apis! {
    ...
    impl frame_benchmarking::Benchmark<Block> for Runtime {
        fn dispatch_benchmark(
            ...
            add_benchmark!(params, batches, pallet_template, VnrsModule);
